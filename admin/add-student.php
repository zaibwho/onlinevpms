...
if ($session_status == false) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    if($cn_pass == $pass){
     ...
     $query=mysqli_query($con, "insert into student(FirstName,LastName,RegNo,Contact,Password) value('$fname','$lname','$reg','$contact1-$contact2','$pass')");
    if ($query) {
    $msg="Student profile is added.";
  }
  else
    {
...
<?php include_once('includes/headernew.php');?>
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input class=" form-control" id="FirstName" name="FirstName" type="text" required = "true"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Last Name</label></div>
                                        <div class="col-12 col-md-9"><input class=" form-control" id="LastName" name="LastName" type="text" required = "true"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Registration Number</label></div>
                                        <div class="col-12 col-md-9"><input id = "num" type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "7" class="form-control" name="stdreg" required></div>
                                    </div>
                                    <div class="row form-group">
