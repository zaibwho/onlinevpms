...
$query=mysqli_query($con,"select ID from stdadmin  where session_id='$adminid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update stdadmin set Password='$newpassword'  where session_id='$adminid'");
